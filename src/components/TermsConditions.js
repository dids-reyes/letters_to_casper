...
function TermsAndConditions() {
  ...
  const sections = [
    ...
    {id:'featured-retention', title:'Burning and Retention of Featured Letters', content:<><p>Burning a letter removes it from public view on the site. If your letter is selected as a featured letter, you agree that Letters to Casper may retain copies for legal recordkeeping and marketing purposes, even after you burn it.</p><p>This featured-letter retention provision applies only if your letter is selected as featured. Keeping a copy does not mean the burned letter remains publicly readable on the site. For questions about retained copies, contact us at <a href="mailto:letters2casper@gmail.com">letters2casper@gmail.com</a>.</p></>},
